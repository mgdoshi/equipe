...
public class PrintDel extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
      ...
      response.sendRedirect("/JOrder/servlets/PrintOrderList?vFrom_Order_Nr="+OrderNr+"&vTo_Order_Nr="+OrderNr+"&dFrom_Order_Dt="+IngDate.dateToStr(OrderDt)+"&dTo_Order_Dt="+IngDate.dateToStr(OrderDt)+"&cDM_OrdStat="+OrderStat+"&pnClientID="+nClientID+"&vTemplName="+vTemplName);
  }
}