...
public class DelEntry extends HttpServlet
{
   ...
   /* Note : Be careful while handelling the following array, any small mistake may 
      ...
      avItemTag[5]  = util.createTextItem( nUserID, "TR_ORDDTLS", "vText1", pvMode, "20", "40", null, null, vTextAttrib );
      avItemTag[6]  = util.createTextItem( nUserID, "TR_ORDDTLS", "vText2", pvMode, "20", "40", null, null, vTextAttrib );
      avItemTag[7]  = util.createTextItem( nUserID, "TR_ORDDTLS", "vText3", pvMode, "20", "40", null, null, vTextAttrib );
      avItemTag[8]  = util.createTextItem( nUserID, "TR_ORDDTLS", "vText4", pvMode, "20", "40", null, null, vTextAttrib );
      avItemTag[9]  = util.createTextItem( nUserID, "TR_ORDDTLS", "vText5", pvMode, "20", "40", null, null, vTextAttrib );
      ...
      try
      {
        ...
        String query = " SELECT * from T_CLSTEMPLDEL "+
     ...
     htag.add(str[6]);
     htag.add("<b>Transport Address :</b>");
     htag.add("<table BORDER=0 CELLSPACING=0 CELLPADDING=0 COLS=2 WIDTH=\"80%\" >");
     htag.add("<tr><td width=\"30%\">&nbsp;Name </td><td>" + db.getName( nUserID, "User") +"</td></tr>");
     htag.add("<tr><td>&nbsp;Address  </td><td>"+rAddress[2]+"</td></tr>");
     htag.add("<tr><td>&nbsp;City </td><td>"+rAddress[6]+"</td></tr>");
