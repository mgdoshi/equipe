...
public class MenuSecForm
{
  public static synchronized Table createMenuSecTable(String Columns, String WhereClause, String Titles, String nLangID)
  {
     String WClause=""; 
     ...
     try
      {
          ...
          String query = "Select " + Columns + " From T_MenuSec " + WClause;
