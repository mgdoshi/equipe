...
public class OrdRepForm
{
  public static Script ShowOrdRepScript(String pvMode,String vPID )
  {
   ...
   public static synchronized Table createOrdRepTable(String Columns, String WhereClause, String Titles,String vPID)
   {
