...
public class PrintOrderList extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
	 ...
	 for( int i=0; i<rOrdNr.size(); i++ )
	 {
       ...
       try
       {
         conn =  db.GetDBConnection();
         stmt = conn.createStatement();
         String query = " Select * From T_OrderDtls Where Fk_Order_ID=" + rOrdID.elementAt(i).toString() +
