...
public class ClientUpdAddress extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
      ...
      Form form = new Form("ClientUpdAddress","POST","_parent",null,null);
      NL blines = new NL(1);
      form.add(blines);
  ...
  public Script ShowClientUpdAddrScript( String vPID )
  {
    String vAddType = null;
    String vCity = null;
    String vState = null;
    ...
    throws IOException, ServletException
    {
     ...
     response.sendRedirect("/JOrder/servlets/ClientAddrTable?pnClientID="+pnClientID+"&pvMessage="); 
  }
}
