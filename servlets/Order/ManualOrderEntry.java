...
public class ManualOrderEntry extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
      ...
      String tname="Purchase Order"; 
      String cname="Company Name"; 
      String caddr="Company Address, City, State, Pin Code, Phone Number, Fax Number"; 
      ...
      String note="";
      String inst="";
      int dflag=-1,sflag=-1,bflag=-1,nflag=-1,iflag=-1,rflag1=-1,rflag2=-1,rflag3=-1;
      int nIndex = 0;
      int nPosCount = 0;
      ...
      String pnOrdDtlsCount = request.getParameter("pnOrdDtlsCount")+"5";
   ...
   /* Note : Be careful while handelling the following array, any small mistake may 
      ...
      if(templname.equalsIgnoreCase("OrdTempl1") || templname.equalsIgnoreCase("None"))
      {
     ...
     {
       ordnr.add( util.createTextItem( nUserID, "TR_ORDER", "vOrder_No", pvMode, "10", "40", null, null, vTextAttrib ));
     }
     ...
     {
       orddt.add( util.createTextItem( nUserID, "TR_ORDER", "dOrder_Dt", pvMode, "10", "10", IngDate.dateToStr(dt), "onBlur=\"top.check_date(document.forms[0].dOrder_Dt)\"", vTextAttrib ));
     }
     ...
     {
       form.add("&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" value=\"Select\" onClick=\"callTable("+bid+")\">&nbsp;<input type=\"button\" value=\"New\" onClick=\"callForm("+bid+")\"> ");
       form.add("&nbsp;&nbsp;Readonly<INPUT Type=\"Radio\" name=\"billid\" value=\"0\" CHECKED>&nbsp;&nbsp;Enterable<INPUT Type=\"Radio\" name=\"billid\" value=\"1\">");
     }
     form.add("</td><td> ");
     if( sflag == 1) 
     ...
     { 
       form.add("&nbsp;&nbsp;<input type=\"button\" value=\"Select\" onClick=\"callTable("+sid+")\">&nbsp;<input type=\"button\" value=\"New\" onClick=\"callForm("+sid+")\"> ");
       form.add("&nbsp;&nbsp;Readonly<INPUT Type=\"Radio\" name=\"shipid\" value=\"0\" CHECKED>&nbsp;&nbsp;Enterable<INPUT Type=\"Radio\" name=\"shipid\" value=\"1\"> ");
     }
     form.add("</td></tr> ");
     form.add("</table> ");
     form.add("<BR> ");
     ...
     if( nflag == -1 ) 
     {
       ...
       form.add( new FormHidden( "note", null, null ) );
       form.add("&nbsp;&nbsp;&nbsp;&nbsp;<INPUT Type=\"CheckBox\" name=\"note\">");
     }
     else if( nflag == 1 ) 
       form.add("<INPUT Type=\"Text\" name=\"notes\" value=\""+note+"\" Size=50 MaxLength=100>");
     else
     ...
     for( int j = 0; j< Integer.parseInt(pnOrdDtlsCount); j++ )
     {
     ...
     tb.add( new FormHidden( "pnOrdDtlsCount", pnOrdDtlsCount, null ) );
     ...
     if( iflag == -1)
     {
       ...
       form.add( new FormHidden( "Instruct", null, null ) );
       form.add("<TD vAlign=\"Top\">&nbsp;&nbsp;<INPUT Type=\"CheckBox\" name=\"Instruct\"></TD> ");
     }
     else if( iflag == 1)
       form.add("<TextArea Name=Inst Rows=3 Cols=50>"+inst+"</TextArea></TD> ");
     else
     ...
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
        form.add("<INPUT Type=\"Text\" name=\"remark1\" value=\""+remark1+"\" Size=50 MaxLength=100></Font></TD>");
        form.add( new FormHidden( "rem1", null, null ) );
        form.add("<TD>&nbsp;&nbsp;<INPUT Type=\"CheckBox\" name=\"rem1\"></TD> ");
     }
     else if( rflag1 == 1) 
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
     ...
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
        form.add("<INPUT Type=\"Text\" name=\"remark2\" value=\""+remark2+"\" Size=50 MaxLength=100></Font></TD>");
        form.add( new FormHidden( "rem2", null, null ) );
        form.add("<TD>&nbsp;&nbsp;<INPUT Type=\"CheckBox\" name=\"rem2\"></TD> ");
     }
     else if( rflag2 == 1) 
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
     ...
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
        form.add("<INPUT Type=\"Text\" name=\"remark3\" value=\""+remark3+"\" Size=50 MaxLength=100></Font></TD>");
        form.add( new FormHidden( "rem3", null, null ) );
        form.add("<TD>&nbsp;&nbsp;<INPUT Type=\"CheckBox\" name=\"rem3\"></TD> ");
     }
     if( rflag3 == 1 )
     {
        form.add("<TD><font face=\"Arial,Helvetica\" size=-1>");
