...
public class OrdTempl extends HttpServlet
{
   ...
   throws IOException, ServletException
   {
     ...
     if( Browser.equals("1") )
     {
       scr = OrdTemplForm.ShowNetsScript( vPID );
       tag = "</Layer>";
     ...
     {
       scr = OrdTemplForm.ShowIntExplScript( vPID );
       tag = "</Div>";
     ...
     out.println("<CENTER><A href=\"JavaScript:getChallanTitle('Enter Challan Title : ',document.forms[0].text2.value)\">Purchase Order</A></font></b></CENTER>");
     out.println(tag);
     out.println("<BR>");
     ...
     {
       out.println("  <b><font color=\"#3333FF\">Order Nr.</font></b>&nbsp;&nbsp; ORDTIN121");
       out.println("  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><font color=\"#3333FF\">Order Dt.</font></b>&nbsp;&nbsp; 12.12.1999 ");
     }
     else
     {
       out.println("  <b><font color=\"#3333FF\">Order Nr.</font></b>&nbsp;&nbsp; ORDTIN121<BR> ");
       out.println("  <b><font color=\"#3333FF\">Order Dt.</font></b>&nbsp;&nbsp; 12.12.1999 ");
     }
     out.println(tag);
     ...
     out.println("</td><td>");
     out.println(str[6]);
     out.println("<b>Shipment Address :</b>");
     out.println("<table BORDER=0 CELLSPACING=0 CELLPADDING=0 COLS=2 WIDTH=\"80%\" >");
     out.println("<tr><td width=\"30%\">&nbsp;Name </td><td>-----------------------</td></tr>");
     out.println("<tr><td>&nbsp;Address  </td><td>----------------------</td></tr>");
     out.println("<tr><td>&nbsp;City </td><td>----------</td></tr>");
     ...
     out.println("<form action=\"/JOrder/servlets/OrdTempl\" method=\"POST\" target=\"mid_frame\"> ");
     ...
     out.println("<br><b><i>&nbsp;&nbsp;&nbsp;&nbsp;Order Details are Entered here at the time of Creating the Order</i></b> ");
     out.println("<BR><BR> ");
     out.println("<hr ALIGN=LEFT SIZE=4 WIDTH=\"80%\"> ");
   ...
   public void doPost(HttpServletRequest request,
        ...
        throws IOException, ServletException
    {
       ...
       try
       {
          ...
          String query = "INSERT INTO T_ClsTempl( Ref_ID, Templ_Name, Text1, Text2, "+
        ...
        if( nMsgID <= 5 )
        {
          response.sendRedirect("/ordhtm/ord.html");
