...
public class Manual extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
      ...
      out.println("      this.location.href = \"/JOrder/servlets/ClsTemplChooser?Browser=1&Flag="+Flag+"\" ");
      out.println("   else ");
      out.println("      this.location.href = \"/JOrder/servlets/ClsTemplChooser?Browser=0&Flag="+Flag+"\" ");
      out.println("   return ");
      out.println(" } ");
      out.println(" </SCRIPT> ");
      out.println(" </HEAD> ");
