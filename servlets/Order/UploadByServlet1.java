...
public class UploadByServlet1 extends HttpServlet
{
	String boundary="";
	String subboundary="";
 	String fileName="";
	...
	throws IOException ,ServletException
	{
	    responce.setContentType("text/html");
 	    PrintWriter out=responce.getWriter();
            ...
            Form form = new Form("/JOrder/servlets/UploadByServlet1", "POST", "_parent", "multipart/form-data", null);
            form.add(new NL());
   			  ...
   			  while(!fileEndflag && len <= totalLength && !fileEndflag)
			  {
				...
				len+=lenx;
                	  ...
                	  Script scr = new Script( "JavaScript", null );
                          ...
                          " with( this.opener.document.all(\"ilayer\")){              \n" +
                          "  innerHTML = \"<A href='JavaScript:getLogo()'><img SRC='/ordimg/"+f.getName()+"' border='0' height=75 width=75 align=ABSCENTER></A>\";\n"+
                          " }\n");
