...
public class User
{
  public static Script ShowUserScript(HttpServletRequest request,String pvMode, String pnEmployeeID )
  {
    ...
    vPID =  cookie.getCookie(request,"PID" );
    if(vPID == null)
    {
      //PkFunc.ShowIllegalEntryInfo;
      return null;
    }
