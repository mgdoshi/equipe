...
public class UserTable extends HttpServlet
{
        ...
        throws IOException, ServletException
    {
      ...
      vFormType = cdata.GetConfigValue( "SY_USER", nLangID, "WD_TABLE", "User / T" );
      ...
      Form form = new Form("UserTable", "POST", "_parent",null,null);
      String vCols = "User_ID,User_Name,Fk_Lang_ID, FK_Client_ID, FK_RecSec_ID";
      String vTitles = "User ID, User Name, Language, Client Name, RecSec Name";
      ...
      form.add(new NL(3)); 
      form.add(UserForm.createUserTable(vCols, null, vTitles));
      body.add(form);
      page.add(head);
      page.add(body);
      out.println(page);
   ...
   public void doPost(HttpServletRequest request,
        ...
        throws IOException, ServletException
    {
      ...
      {
         vUserID=request.getParameterValues("nDelete");
         vIDArray=Parse.parse(vUserID[0],"~");
         try
         {
           conn = db.GetDBConnection();
           pstmt = conn.prepareStatement("DELETE FROM T_User WHERE User_Id=?"); 
