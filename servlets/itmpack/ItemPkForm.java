...
public class ItemPkForm
{
  public static Script ShowItemPkScript(HttpServletRequest request, String pvMode , String vPID)
  {
    String nLangID=null;
    String nUserID=null;
    String vItemPack=null;
    ...
    vItemPack = config.GetConfigValue( "ST_ITEMPACK", nLangID, "BL_LABEL.B_ITEMPACK_ITEMPACK_NAME", "ITEMPACK Class" );
    ...
    if( pvMode==null || pvMode.equals("") || pvMode.equalsIgnoreCase("null"))
    {
     scrdata.add("  function submit_form( pvAction ) { \n"  +
                 ...
                 "       this.location.href = \"/JOrder/servlets/ItemPkFrame?pvMode=I&pnItemPackID=\" }\n" +
    ...
    else
    {
      scrdata.add(" function submit_form( pvAction ) {	\n" +
        	  ...
        	  "       aField = new Array( \"" + vItemPack + "\", vItemPack_Name.value)\n" +
  ...
  public static synchronized Table createItemPkTable(String Columns, String WhereClause, String Titles)
  {
     String WClause=""; 
     ...
     try
      {
          ...
          String query = "Select " + Columns + " From T_ITEMPACK " + WClause;
          rs = stmt.executeQuery(query);
          while(rs.next())
          {
            datarow = new TableRow("left", null, null);
            String id = rs.getString(1);
            String URL = "/JOrder/servlets/ItemPkFrame?pvMode=U&pnItemPackID="+id;
            Anchor anc = new Anchor( URL, "ItemPack # "+id, null, "_parent", null);
