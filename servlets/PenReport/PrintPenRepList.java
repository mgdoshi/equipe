...
public class PrintPenRepList extends HttpServlet
{
    ...
    throws IOException, ServletException
    {
      ...
      vFormType = cdata.GetConfigValue( "TR_ORDER", nLangID, "WD_FORM_LIST1", "Pending Order List " );
	 ...
	 for( int i=0; i<rOrdNr.size(); i++ )
	 {
       ...
       try
       {
         ...
         String query = " Select * From T_OrderDtls ort, T_Item itm "+
