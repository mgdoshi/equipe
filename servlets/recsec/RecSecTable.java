...
public class RecSecTable extends HttpServlet
{
        ...
        throws IOException, ServletException
    {
      ...
      vFormType = cdata.GetConfigValue( "SY_RECSEC", nLangID, "WD_TABLE", " Record Security / T" );
      ...
      Form form = new Form("RecSecTable", "POST", "_parent",null,null);
      String vCols = "RecSec_ID, RecSec_Name, RecSec_Desc";
      String vTitles = "RecSec ID, RecSec Name, RecSec Desc";
      form.add(new FormHidden("pnTransID",nTransID,null)); 
      form.add(new FormHidden("nDelete","",null));
      form.add(new NL(3)); 
      form.add(RecSec.createRecSecTable(vCols, null, vTitles));
      body.add(form);
      page.add(head);
      page.add(body);
      out.println(page);
   ...
   public void doPost(HttpServletRequest request,
        ...
        throws IOException, ServletException
    {
      ...
      {
         vRecSecID=request.getParameterValues("nDelete");
         vIDArray=Parse.parse(vRecSecID[0],"~");
         try
         {
           conn = db.GetDBConnection();
           stmt = conn.prepareStatement("DELETE FROM T_RecSec WHERE RecSec_Id=?");
