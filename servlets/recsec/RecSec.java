...
public class RecSec
{
  public static Script ShowRecSecScript(HttpServletRequest request,String pvMode, String vPID)
  {
    String vRecSecName;
    ...
    vRecSecName    = config.GetConfigValue( "SY_RECSEC", nLangID, "BL_LABEL.B_RECSEC_RECSEC_NAME", "RecSec Name" );
    ...
    if( pvMode== null || pvMode.equals("") || pvMode.equalsIgnoreCase("null"))
    {
     scrdata.add("  function submit_form( pvAction ) { \n"  +
                 ...
                 "      this.location.href = \"/JOrder/servlets/RecSecFrame?pvMode=I&pnRecSecID=\"   \n" +
                 "  }\n" +
    ...
    else
    {
      scrdata.add(" function submit_form( pvAction ) {	\n" +
                  ...
                  "     var FuncWindow 		 	\n" +
                  "     with( this.right_frame.document.forms[0] ){\n" +
                  "       var vURL = \"/JOrder/servlets/ShowRecSecWin?pnRecSecID=\" +pnRecSecID.value \n"+
                  "       if ( pvAction == \"Assign\" ) {                        	          \n"+ 
                  ...
                  "       aField = new Array( \""+ vRecSecName + "\", vRecSec_Name.value)\n" +
  ...
  public static synchronized Table createRecSecTable(String Columns, String WhereClause, String Titles)
  {
     String WClause=""; 
     String Default  = "BORDER=0 BGCOLOR=\"#FFFFCA\"";
     String DefHeadCol =  "BGCOLOR=\"#666666\"";

     String rsecname = null;
     if( WhereClause != null )
       WClause = WhereClause;
     ...
     try
      {
          ...
          String query = " Select " + Columns + " From T_RecSec "+ WClause;
          ...
          while(rs.next())
          {
            ...
            String URL = "/JOrder/servlets/RecSecFrame?pvMode=U&pnRecSecID="+id;
            Anchor anc = new Anchor( URL, "RecSec # "+id, null, "_parent", null);
