...
public class DelRepForm
{
  public static Script ShowDelRepScript(String pvMode,String vPID )
  {
    ...
    else if(pvMode!=null && pvMode.equalsIgnoreCase("Q"))
    {
      scrdata.add(" function submit_form( pvAction ) {  \n" +
                  ...
                  "  aField = new Array('"+vTemplName+"', vTemplName.options[vTemplName.selectedIndex].value  )\n" +
   ...
   public static synchronized Table createDelRepTable(String Columns, String WhereClause, String Titles)
   {
     String WClause=""; 
