...
public class ItemClsForm
{
  public static Script ShowItemClsScript(HttpServletRequest request, String pvMode, String vPID)
  {
    String nLangID=null;
    String nUserID=null;
    String vItemClass=null;
    ...
    vItemClass = config.GetConfigValue( "ST_ITEMCLASS", nLangID, "BL_LABEL.B_ITEMCLASS_ITEMCLASS_NAME", "Param Class" );
    ...
    if( pvMode==null || pvMode.equals("") || pvMode.equalsIgnoreCase("null"))
    {
     scrdata.add("  function submit_form( pvAction ) { \n"  +
                 ...
                 "       this.location.href = \"/JOrder/servlets/ItemClsFrame?pvMode=I&pnItemClassID=\" }\n" +
    ...
    else
    {
      scrdata.add(" function submit_form( pvAction ) {	\n" +
        	  ...
        	  "       aField = new Array( \"" + vItemClass + "\", vItemClass_Name.value)\n" +
  ...
  public static synchronized Table createItemClsTable(String Columns, String WhereClause, String Titles)
  {
     String WClause=""; 
     ...
     try
      {
          ...
          String query = "Select " + Columns + " From T_ItemClass " + WClause;
          rs = stmt.executeQuery(query);
          while(rs.next())
          {
            datarow = new TableRow("left", null, null);
            String id = rs.getString(1);
            String URL = "/JOrder/servlets/ItemClsFrame?pvMode=U&pnItemClassID="+id;
            Anchor anc = new Anchor( URL, "ItemClass # "+id, null, "_parent", null);
